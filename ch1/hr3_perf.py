...
from ch1.hr3 import hackerlandRadioTransmitters_dp, hackerlandRadioTransmitters_dp_memo, \
    hackerlandRadioTransmitters_dp_builtin_cache
...
test_func(hackerlandRadioTransmitters_dp)
test_func(hackerlandRadioTransmitters_dp_memo)
test_func(hackerlandRadioTransmitters_dp_builtin_cache)
